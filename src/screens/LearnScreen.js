        ...
        ListFooterComponent={
          filtered.length > 0 ? (
            <View style={styles.footer}>
              <Text style={styles.footerText}>More articles coming soon 💛</Text>
            </View>
          ) : null
        }
        renderItem={({ item }) => (
